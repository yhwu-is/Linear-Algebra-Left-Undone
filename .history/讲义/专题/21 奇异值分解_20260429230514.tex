    ...
    \begin{enumerate}
        \item 由伴随的运算性质可知
              \[
                  (T^*T)^* = T^*(T^*)^* = T^*T,
              \]
              因此 $ T^*T $ 是自伴的. 又对任意 $ v \in V $，有
              \[
                  \langle T^*Tv, v \rangle = \langle Tv, Tv \rangle = \lVert Tv \rVert^2 \geqslant 0.
              \]
              故 $ T^*T $ 是正算子.

        \item 若 $ v \in \ker T $，则 $ Tv = 0 $，从而 $ T^*Tv = 0 $，故 $ \ker T \subseteq \ker T^*T $. 反过来，若 $ v \in \ker T^*T $，则
              \[
                  0 = \langle T^*Tv, v \rangle = \lVert Tv \rVert^2,
              \]
              因而 $ Tv = 0 $，即 $ v \in \ker T $. 故 $ \ker T^*T = \ker T $.

        \item 由上一讲关于像空间与核空间的关系可知
              \[
                  \im T^* = (\ker T)^{\perp}.
              \]
              又因为 $ T^*T $ 是自伴算子，所以
              ...
              结合第 2 条，便有
              \[
                  \im T^*T = (\ker T^*T)^{\perp} = (\ker T)^{\perp} = \im T^*.
              \]
        ...
        \item 由线性映射基本定理，
              ...
              同理，
              \[
                  \dim \im T^* = \dim V - \dim \ker T = \dim \im T,
              \]
              其中用到了第 3 条中的 $ \im T^* = (\ker T)^\perp $. 再由第 3 条知
              \[
                  \dim \im T^*T = \dim \im T^*.
              \]
              因此
              \[
                  \dim \im T = \dim \im T^* = \dim \im T^*T.
              \]
    \end{enumerate}
\end{proof}
