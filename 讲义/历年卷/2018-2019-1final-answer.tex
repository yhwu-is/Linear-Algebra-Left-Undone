...
\begin{enumerate}
    ...
    \item \begin{enumerate}
        ...
        方程组 $(-3E-A)X = 0, (2E-A)X = 0$ 的基础解系为 $(-1,0,2)^T, (0,1,0)^T, (2,0,1)^T$.

        正交规范化得变换矩阵 $Q=(\gamma_{1},\gamma_{2},\gamma_{3})$，其中 $\gamma_1=\dfrac{1}{\sqrt{5}}(-1,0,2)^T, \gamma_2=(0,1,0)^T, \gamma_3=\dfrac{1}{\sqrt{5}}(2,0,1)^T$.

        \item 由于 $A$ 有负的特征值，因此非正定.
    \end{enumerate}

    \item 见\autoref{ex:非齐次解的进一步结构}.
