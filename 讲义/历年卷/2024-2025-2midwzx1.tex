...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        证明
        \[\dfrac{a_0^2}{2}+\sum\limits_{k=1}^{\infty}(a_k^2+b_k^2)\leq \int_{-\pi}^{\pi}f^2(x)\,\mathrm{d}x.\]
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item 设 $U$ 是 $V$ 的子空间. $\Gamma\colon\mathcal{L}(V/U,W)\to\mathcal{L}(V,W)$ 定义为 $\Gamma(S)=S\circ\pi$，则 \(\operatorname{range}\Gamma=\{T\in\mathcal{L}(V,W)|\forall u\in U , Tu=0\}\).
