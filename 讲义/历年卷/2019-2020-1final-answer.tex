...
\begin{enumerate}
    ...
    \item \begin{enumerate}
        ...
        \item 配方得 $X^\mathrm{T}AX=(\sqrt{2}x_1+\dfrac{\sqrt{2}}{2} x_2 + \dfrac{\sqrt{2}}{2} x_3)^2+(\dfrac{\sqrt{6}}{2} x_2 - \dfrac{\sqrt{2}}{2} x_3)^2$.

        令 $\begin{cases}
            y_1 = \sqrt{2}x_1+\dfrac{\sqrt{2}}{2} x_2 + \dfrac{\sqrt{2}}{2} x_3 \\
            y_2 = \dfrac{\sqrt{6}}{2} x_2 - \dfrac{\sqrt{2}}{2} x_3 \\
            y_3 = x_3
        \end{cases}$，则 $Y=\begin{pmatrix}
            \sqrt{2} & \dfrac{\sqrt{2}}{2} & \dfrac{\sqrt{2}}{2} \\[0.5em]
            0 & \dfrac{\sqrt{6}}{2} & -\dfrac{\sqrt{2}}{2} \\[0.5em]
            0 & 0 & 1
        \end{pmatrix} X$，所求的 $Q = \begin{pmatrix}
            \dfrac{\sqrt{2}}{2} & -\dfrac{\sqrt{6}}{6} & -1 \\[0.5em]
            0 & \dfrac{\sqrt{6}}{3} & 1 \\[0.5em]
            0 & 0 & 1
        \end{pmatrix}$. 二次型的正惯性系数为 $2$，负惯性系数为 $0$.
    \end{enumerate}
