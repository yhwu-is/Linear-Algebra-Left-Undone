...
\begin{solution}
    ...
    单位化：
    \[ \lVert u_2 \rVert^2 = \langle x, x \rangle = \int_{-1}^1 x^2 \,\mathrm{d}x = \left(\frac{1}{3}x^3\right)\displaystyle\vert_{-1}^1 = \frac{2}{3}, e_2 = \frac{u_2}{\lVert u_2 \rVert} = \frac{x}{\sqrt{2/3}} = \sqrt{\frac{3}{2}} x. \]
